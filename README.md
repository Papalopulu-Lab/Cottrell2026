...
Several publicly available RNA-seq datasets were analysed to examine HES1 expression in various context, to validate our findings, as described in the paper. R codes are provided here to conduct this analysis.
